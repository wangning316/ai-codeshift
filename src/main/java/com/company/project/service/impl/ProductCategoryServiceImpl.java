...
public class ProductCategoryServiceImpl extends ServiceImpl<ProductCategoryMapper, ProductCategoryPO> implements ProductCategoryService {
    ...
    @Override
    public Long createProductCategory(ProductCategoryPO productCategory) {
        // 参数校验
        validateCreateParams(productCategory);
     ...
     */
    private void validateCreateParams(ProductCategoryPO productCategory) {
